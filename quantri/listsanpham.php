...
function anhdaidien($arrstr, $height){
    //$arrstr là mảng các hình ảnh có dạng anh1, anh
    $arr = explode(';', $arrstr);
        ...
        ?> 
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-danger" href="deleteproduct.php?id=<?=$row['pid']?>" onclick="return confirm('Bạn chắc chắn xoá mục ngày?');"> Delete </a>
                            </td>
                        </tr>
                        <?php
    }
